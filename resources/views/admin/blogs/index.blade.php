                    ...
                    <div class="col-sm-12">
                        <div class="ecommerce-header-items">
                            <div class="result-toggler">
                                <div class="search-results">{{ $blogs->count() }} results found</div>
                            </div>
                            <div class="view-options d-flex">
                                <div class="button-group-spacing">
                                    {{-- @if (havePermission('blogs','export')) --}}
                                    {{-- {{ route('blogs.mass_export') }} --}}
                                        {{-- <form action="" method="POST" class="d-inline-block w-100 w-sm-auto">
                                            @csrf
                                            ...
                                            <div class="modal fade" id="csvImportModal" tabindex="-1" role="dialog" aria-hidden="true">
                                                <div class="modal-dialog modal-lg modal-dialog-centered" role="document">
                                                    <div class="modal-content position-relative">
                                                        {{-- {{ route('blogs.import') }} --}}
                                                        <form action="" method="POST" id="importBlogForm" enctype="multipart/form-data">
                                                            @csrf
                                                            <div class="modal-header">
                                                                <h5 class="modal-title">Import Blogs</h5>
                                                            ...
                                                            <div class="modal-body">
                                                                <div class="form-group my-2">
                                                                    <p class="form-label">Import Blogs</p> <span id="importError" class="text-danger"></span>
                                    ...
                                    {{-- @if (havePermission('blogs','create')) --}}
                                        <a class="btn btn-warning waves-effect w-100 w-sm-auto" href="{{ route('blogs.create') }}">
                                            ...
                                            <span class="pl-50">Add New Blog</span>
                                        </a>
                                    {{-- @endif --}}
                    ...
                    @foreach ($blogs as $blog)
                        <div class="col-4">
                            <div class="card ecommerce-card">
                                ...
                                <div class="item-options text-center mb-1">

                                    <div class="item-options__btn-wrapper">
                                        <a href="{{ route('blogs.edit', $blog->id) }}" class="btn btn-warning waves-float waves-light">
