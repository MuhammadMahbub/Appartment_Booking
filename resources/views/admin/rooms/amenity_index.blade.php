...
@section('content')
    ...
    @push('all_modals')
    <!-- Create Modal -->
    <div class="modal fade" id="amenityCreate" tabindex="-1" role="dialog" aria-labelledby="exampleModalCenterTitle" aria-hidden="true">
        <div class="modal-dialog modal-md modal-dialog-centered" role="document">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title" id="exampleModalLabel"> {{ __('Amenity Create') }} </h5>
                ...
                <form action="{{ route('amenity.store') }}" method="POST" enctype="multipart/form-data">
                    <div class="modal-footer">
                        ...
                        <div class="col-12">
                            <div class="form-group">
                                <label for="name"> {{ __('Icon') }} <span class="text-danger">*</span> (<a href="https://fontawesome.com/icons">icon search here:</a> )</label>
            ...
            <div class="card">
                <div class="card-header">
                    <div class="button-group-spacing w-100 text-right">
                        ...
                        <button class="btn btn-warning waves-effect w-100 w-sm-auto" data-toggle="modal" data-target="#amenityCreate">
                ...
                <div class="card-body">
                    ...
                    <div class="table-responsive">
                        <table class="table table-bordered">
                            ...
                            <tbody id="render_amenity">

                                @include('admin.includes.amenity_index')
...
<script>
    $(document).ready(function () {
        ...
        $('#all_select_checkbox').change(function(){
            ...
            if($(this).is(":checked")){
                ...
                $("#delete_all").on('click', function(){
                    ...
                    $.ajax({
                    url: "{{ route('amenity_multi_delete') }}",
                    type: 'POST',
                    data: {
                        ids: ids,
                    },
            ...
            else
            {
                ...
                $('#export_all').val(ids);
                    ...
                    $("#delete_all").on('click', function(){
                        ...
                        $.ajax({
                                url: "{{ route('amenity_single_delete') }}",
                                type: 'POST',
                                data: {
                                    ids: ids,
                                },
        ...
        $('#filter__date').on('click',function(){
            ...
            $.ajax({
                type: 'POST',
                url: "{{ route('date_wise_search_amenity') }}",
                data: {
                    from_date: from_date,
                    to_date: to_date,
                },
                success: function(response) {
                    ...
                    if ((response.count)*1 <  1) {
                        $('#render_amenity').html('<tr ><td colspan="1000" class="text-danger text-center py-3">No Data Found</td></tr>');
                    } else {
                        $('#render_amenity').html(response.data);
                    }
        ...
        $.ajax({
            type: 'POST',
            url: "{{ route('date_wise_clear_amenity') }}",
