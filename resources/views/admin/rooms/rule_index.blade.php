...
@section('content')
    ...
    @push('all_modals')
    <!-- Create Modal -->
    <div class="modal fade" id="ruleCreate" tabindex="-1" role="dialog" aria-labelledby="exampleModalCenterTitle" aria-hidden="true">
        <div class="modal-dialog modal-md modal-dialog-centered" role="document">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title" id="exampleModalLabel"> {{ __('Home Rule Create') }} </h5>
            ...
            <div class="card">
                <div class="card-header">
                    <div class="button-group-spacing w-100 text-right">
                        ...
                        <button class="btn btn-warning waves-effect w-100 w-sm-auto" data-toggle="modal" data-target="#ruleCreate">
                ...
                <div class="card-body">
                    ...
                    <div class="table-responsive">
                        <table class="table table-bordered">
                            ...
                            <tbody id="render_rule">

                                @include('admin.includes.rule_index')
...
<script>
    $(document).ready(function () {
        ...
        $('#filter__date').on('click',function(){
            ...
            $.ajax({
                type: 'POST',
                url: "{{ route('date_wise_search_rule') }}",
                data: {
                    from_date: from_date,
                    to_date: to_date,
                },
                success: function(response) {
                    ...
                    if ((response.count)*1 <  1) {
                        $('#render_rule').html('<tr ><td colspan="1000" class="text-danger text-center py-3">No Data Found</td></tr>');
                    } else {
